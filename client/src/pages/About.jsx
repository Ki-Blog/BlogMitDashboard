  ...
  return (
    <div className='min-h-screen flex my-10 justify-center'>
      <div className='max-w-2xl mx-auto p-3 text-center'>
        <div>
          <h1 className='text-5xl font font-semibold text-[#0e93b7] dark:text-[#0096bf] text-center my-7'>
            About
          </h1>
          <div className='text-md text-gray-500 flex flex-col gap-6'>
            ...
            <h2 className="text-[#0e93b7] dark:text-[#0096bf] font font-semibold text-2xl">Unsere Vision</h2>
            <p>
            ...
            <h2 className="text-[#0e93b7] dark:text-[#0096bf] font font-semibold text-2xl">Unsere Team</h2>
            <p>
            ...
            <h2 className="text-[#0e93b7] dark:text-[#0096bf] font font-semibold text-2xl">Unsere Projekte</h2>
            <p>
            ...
            <h2 className="text-[#0e93b7] dark:text-[#0096bf] font font-semibold text-2xl">Kontaktieren Sie uns</h2>
            <p>
